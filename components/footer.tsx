...
const Footer = () => {
    ...
    return (
        ...
        <footer className="bg-secondary relative  text-secondary-foreground px-6 w-screen flex align-center justify-evenly min-h-[400px] flex-col md:flex-row py-1">

            <Image
                src={`/bigLeaf.svg`}
                alt={"bigLeaf"}
                className="absolute h-[200px] w-[200px]  -top-[320px]  left-0 z-10    min-[768px]:h-[300px] min-[768px]:w-[300px] min-[768px]:-top-[200px]"
                width={450}
                height={450}
