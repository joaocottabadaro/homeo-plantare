...
export const Slide2 = <div className=" flex h-full items-center md:items-start text-center md:text-start flex-col flex-wrap w-full 2xl:w-5/12 justify-center  gap-6   px-4 md:pl-20">   <Image
  ...
  priority
/><h2 className=" z-10 text-primary-foreground   xl:leading-[77px] lg:text-2xl   xl:text-4xl font-bold leading-10">Homeopatia para Grãos</h2> <Button className="z-10"><a aria-label="entrar em contato pelo whatsapp" href="https://wa.me/5532984565731" target='_blank'> Cadastre-se</a></Button></div>
