...
export const Slide1 = <div className=" w-full	 xl:w-1/2 flex h-full items-center md:items-start  text-center md:text-start flex-col flex-wrap w-full 2xl:w-5/12 justify-center gap-2  px-4 md:pl-20">
  <Image
    src={`/back1.png`}
    alt={"background1"}
